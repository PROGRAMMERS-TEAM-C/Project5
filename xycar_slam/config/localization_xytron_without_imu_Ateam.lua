...
TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.max_range = 30. --50.
TRAJECTORY_BUILDER_2D.loop_closure_adaptive_voxel_filter.max_length = 0.9
TRAJECTORY_BUILDER_2D.loop_closure_adaptive_voxel_filter.min_num_points = 100
TRAJECTORY_BUILDER_2D.loop_closure_adaptive_voxel_filter.max_range = 30.--50.
TRAJECTORY_BUILDER_2D.use_online_correlative_scan_matching = true
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.linear_search_window = 0.1
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.angular_search_window = math.rad(20.)
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.translation_delta_cost_weight = 1e-1 --1
TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.rotation_delta_cost_weight = 1e-1
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.occupied_space_weight = 1 --10.
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.translation_weight = 10 --20.
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 40. --35.
...
POSE_GRAPH.constraint_builder.min_score = 0.85 --0.55
POSE_GRAPH.optimization_problem.huber_scale = 1e1
POSE_GRAPH.constraint_builder.global_localization_min_score = 0.6 --0.65

POSE_GRAPH.constraint_builder.sampling_ratio = 0.3 --0.003
...
POSE_GRAPH.optimization_problem.ceres_solver_options.max_num_iterations = 10 --20
POSE_GRAPH.optimization_problem.ceres_solver_options.num_threads = 4
POSE_GRAPH.max_num_final_iterations = 200
POSE_GRAPH.global_sampling_ratio = 0.5 --0.09 --0.0003
