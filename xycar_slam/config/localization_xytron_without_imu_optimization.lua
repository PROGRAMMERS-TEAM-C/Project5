...
TRAJECTORY_BUILDER_2D.adaptive_voxel_filter.max_range = 35.
TRAJECTORY_BUILDER_2D.loop_closure_adaptive_voxel_filter.max_length = 1.5
...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.ceres_solver_options.max_num_iterations = 13
...
POSE_GRAPH.global_constraint_search_after_n_seconds = 17.
